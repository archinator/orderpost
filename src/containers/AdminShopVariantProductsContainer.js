...
import AdminShopVariantProducts from '../components/AdminShopVariantProducts';
...
export default connect(mapStateToProps, mapDispatchToProps)(AdminShopVariantProducts);